...
<section class="publicMian ">
    ...
    <div class="right">
        <div class="location">
            ...
            <span>设备管理页面 >> 设备信息查看页面</span>
        </div>
        <div class="providerView">
            <p><strong>设备编号：</strong><span>${deviceInfo.deviceId}</span></p>
            <p><strong>设备名称：</strong><span>${deviceInfo.deviceName}</span></p>
            <p><strong>供应商编号：</strong><span>${deviceInfo.provider.providerId}</span></p>
            <p><strong>数量：</strong><span>${deviceInfo.deviceNum}</span></p>
            <p><strong>单价：</strong><span>${deviceInfo.deviceMoney}</span></p>
            <p><strong>设备类型：</strong><span>${deviceInfo.deviceType}</span></p>
            <a href="${pageContext.request.contextPath}/deviceList">返回</a>
        </div>
    </div>
</section>
<footer class="footer">
