...
<section class="publicMian ">
    ...
    <div class="right">
        ...
        <div class="providerView">
            <p><strong>供应商编码：</strong><span>${provider.getProviderId()}</span></p>
            <p><strong>供应商名称：</strong><span>${provider.getProviderName()}</span></p>
            <p><strong>联系人：</strong><span>${provider.getContact()}</span></p>
            <p><strong>联系电话：</strong><span>${provider.getContactTelephone()}</span></p>
            <p><strong>传真：</strong><span>${provider.getFax()}</span></p>
            <p><strong>描述：</strong><span>${provider.getDescription()}</span></p>

            <a href="${pageContext.request.contextPath}/provider/allProviders">返回</a>
        </div>
    </div>
</section>
<footer class="footer">
