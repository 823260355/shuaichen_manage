...
<section class="publicMian ">
    ...
    <div class="right">
        ...
        <div class="providerAdd">
            <form action="${pageContext.request.contextPath}/provider/updateProvider" method="post">
                <!--div的class 为error是验证错误，ok是验证成功-->

                <input type="hidden" name="providerId" id="providerId" value="${provider.getProviderId()}"/>
                <div>
                    <label for="providerName">供应商名称：</label>
                    <input type="text" name="providerName" id="providerName" value="${provider.getProviderName()}"/>
                    <span >*</span>
                </div>
                <div>
                    <label for="contact">联系人：</label>
                    <input type="text" name="contact" id="contact" value="${provider.getContact()}"/>
                    <span>*</span>

                </div>
                <div>
                    <label for="contactTelephone">联系电话：</label>
                    <input type="text" name="contactTelephone" id="contactTelephone" value="${provider.getContactTelephone()}"/>
                    <span></span>
                </div>
                <div>
                    <label for="contactAddress">联系地址：</label>
                    <input type="text" name="contactAddress" id="contactAddress" value="${provider.getContactAddress()}"/>
                    <span></span>

                </div>
                <div>
                    <label for="fax">传真：</label>
                    <input type="text" name="fax" id="fax" value="${provider.getFax()}"/>
                    <span></span>

                </div>
                <div>
                    <label for="description">描述：</label>
                    <input type="text" name="description" id="description" value="${provider.getDescription()}"/>
                    <span></span>

                </div>
                <div>
                    <label for="creationTime">创建时间：</label>
                    <input type="text" name="creationTime" id="creationTime" value="${provider.getCreationTime()}"/>
