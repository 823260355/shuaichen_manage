...
<section class="publicMian ">
    ...
    <div class="right">
        ...
        <div class="providerAdd">
            <form method="post" action="${pageContext.request.contextPath}/bill/afterbillUpdate">
                <!--div的class 为error是验证错误，ok是验证成功-->
                <div class="">
                    <label for="billId">账单编码：</label>
                    <input type="text" name="billId" id="billId" value="${bill.getBillId()}"/>
                    <span>*</span>
                </div>
                <div class="">
                    <label for="userId">租户编码：</label>
                    <input type="text" name="userId" id="userId" value="${bill.getUserId()}"/>
                    <span>*</span>
                </div>
                <div>
                    <label for="deviceId">设备编码：</label>
                    <input type="text" name="deviceId" id="deviceId" value="${bill.getDeviceId()}"/>
                    <span>*</span>
                </div>
                <div>
                    <label for="money">总金额：</label>
                    <input type="text" name="money" id="money" value="${bill.getMoney()}"/>
                    <span>*</span>
                </div>
                <div>
                    <label for="checked">是否付款：</label>
                    <input type="text" name="checked" id="checked" value="${bill.getChecked()}"/>
                    <span>*</span>
                </div>
                <div>
                    <label for="date">创建时间：</label>
                    <input type="text" name="date" id="date" value="${bill.getDate()}"/>
